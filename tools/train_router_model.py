...
CORPUS: dict[str, list[str]] = {
    "greeting": [
        ...
        "hey, you around?", "hello, can you help me today?",
    ...
    "recall": [
        ...
        "find my earlier message about flutter",
        "search my history for riverpod",
        "did we talk about authentication before?",
        "what was that command i asked about?",
        "look up my previous conversation on caching",
        "what did we decide yesterday?",
        "recall our discussion about sqlite",
        "which chat mentioned onnx?",
        "i asked something about streaming before, what was it",
        "show me what i wrote about offline mode",
        "remind me of the plan we made",
        "what have we covered so far?",
        "go back to what i said about tokens",
    ],
    "code": [
        "write a dart function to reverse a string",
        "show me a python example of a decorator",
        "how do i parse json in flutter?",
        "fix this null safety error",
        "refactor this widget into smaller pieces",
        "write a sql query to join two tables",
        "give me a regex for email validation",
        "implement a debounce in dart",
        "how to write a unit test for a stream",
        "convert this callback to async await",
        "explain this stack trace",
        "generate a class with copywith",
        "what's the syntax for a sealed class",
        "debug my riverpod provider",
        "write a bash script to rename files",
        "optimise this for loop",
    ],
    "summarize": [
        "summarise this article",
        "give me a tldr",
        "summarize the text below",
        "can you condense this into bullet points?",
        "shorten this paragraph",
        "what are the key points here?",
        "make this into an executive summary",
        "tl;dr please",
        "extract the main ideas from this",
    ...
    "question": [
        ...
        "tell me about the history of jakarta",
        "how should i structure a mobile app?",
        "what are the tradeoffs of on-device inference?",
        "define technical debt",
        "how do i improve app startup time?",
...
def main() -> None:
    ...
    probe_texts = [
        "hello there",
        "thanks a lot!",
        "what did i say about riverpod earlier?",
        "write a dart function that sorts a list",
